...
export const InvestmentPerformance: React.FC<InvestmentPerformanceProps> = ({ investments }) => {
  const sortedByReturn = [...investments].sort((a, b) => b.returnRate - a.returnRate);
        ...
        {sortedByReturn.slice(0, 3).map((investment) => (
          <div key={investment.id} className="flex justify-between items-center">
            ...
            <div className="text-right">
              <p className="font-bold text-green-600">+{investment.returnRate}%</p>
